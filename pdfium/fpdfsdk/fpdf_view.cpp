...
FPDF_EXPORT void FPDF_CALLCONV FPDF_RenderPage(HDC dc,
	...
	return FPDF_RenderPagePrintWidget(dc, page, start_x, start_y, size_x, size_y,
		rotate, flags, false);

}

FPDF_EXPORT void FPDF_CALLCONV FPDF_RenderPagePrintWidget(HDC dc,
                                               FPDF_PAGE page,
                                               int start_x,
                                               int start_y,
                                               int size_x,
  ...
  if (!bNewBitmap && !bHasMask) {
    ...
    CPDFSDK_RenderPageWithContextEx(context, pPage, start_x, start_y, size_x,
                                  size_y, rotate, flags,
                                  /*color_scheme=*/nullptr,
                                  /*need_to_restore=*/true, /*pause=*/nullptr,allow_print_widget);
    return;
  }
  ...
  CPDFSDK_RenderPageWithContextEx(context, pPage, start_x, start_y, size_x,
                                ...
                                /*pause=*/nullptr,allow_print_widget);
